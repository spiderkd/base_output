...
// registry/riso/ui/ink-density-meter.tsx — Ink Density Meter ★
//
// Visual system:
...
export function InkDensityMeter({
  value,
  label,
  height = 160,
  width = 44,
  ...
  return (
    ...
    >
      ...
      <div className="relative">
        ...
        <div
          aria-hidden
          className="absolute inset-0 bg-[var(--riso-secondary)] translate-x-1 translate-y-1 opacity-45"
        />
