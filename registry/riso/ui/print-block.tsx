...
// registry/new-york/ui/print-block.tsx — Risograph Print Block
//
...
interface PrintBlockProps extends React.HTMLAttributes<HTMLDivElement>, RisoThemeProps {
...
export function PrintBlock({ ink = "primary",
  rotate = 0,
  children,
  className,
  ...
  return (
    ...
    >
      ...
      <div aria-hidden style={{ filter: "url(#riso-grain-fill)", background: bg }} className="absolute inset-0 mix-blend-multiply opacity-60 pointer-events-none" />

      {/* Halftone dot texture at mid-opacity */}
      <div aria-hidden className="absolute inset-0 [background-image:radial-gradient(circle,rgba(255,255,255,0.18)_1.5px,transparent_0)] [background-size:4px_4px] pointer-events-none" />
